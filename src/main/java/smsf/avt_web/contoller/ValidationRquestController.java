...
@Controller
public class ValidationRquestController {
    @PostMapping("/validationRequest")
    public ResponseEntity<String> validationRequest(@RequestBody Map<String, Object> payload) throws IOException {
